...
import containerBg from "@/assets/images/container-background.png";
    ...
    <div className="container">
      <section className="container__left">
        ...
        <section className="container__bottom">
          <h2 className="container__subtitle">{ msgStr("mainTitle") }</h2>
          <p className="container__text">{ msgStr("mainSubtitle") }</p>
        </section>
      </section>
